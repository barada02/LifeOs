...
function App() {
  ...
  return (
    <div className="flex w-full h-full flex-row text-on-surface bg-background font-['Inter']">
      <aside className={`sidebar-transition flex-shrink-0 ${sidebarWidth} bg-surface-container border-r border-outline-variant flex flex-col h-full py-lg px-2 z-50 relative group`}>
        ...
        >
          <span className="material-symbols-outlined text-[16px]">{sidebarWidth === 'w-20' ? 'chevron_right' : 'chevron_left'}</span>
        </button>
      </aside>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <aside className={`sidebar-transition flex-shrink-0 ${rightSidebarWidth} bg-surface-container border-l border-outline-variant flex flex-col h-full z-50 relative`}>
            <button 
            ...
            >
              <span className="material-symbols-outlined text-[16px]">{rightSidebarWidth === 'w-80' ? 'chevron_right' : 'chevron_left'}</span>
            </button>
